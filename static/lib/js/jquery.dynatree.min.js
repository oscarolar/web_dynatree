...
if(opts.checkbox&&data.hideCheckbox!==true&&!data.isStatusNode){res+=cache.tagCheckbox;}if(data.icon){var img_src=data.icon;if (data.icon[0]!='/'){img_src=opts.imagePath+img_src;};res+="<img src='"+img_src+"' alt='' />";}else if(data.icon===false){noop();}else{res+=cache.tagNodeIcon;}
